...
class STDataset(Dataset):
    ...
    def __init__(
        ...
        self.data = load_dataset("patrickvonplaten/librispeech_asr_dummy",
                                 "clean",
                                 split="validation")
    ...
    def __getitem__(self, ii):
        ...
        return {"speech_input": speech_input}
...
def collate_batch(batch: List):
    ...
    input_values = encoder_processor(speech_input,
                                     return_tensors="pt",
                                     padding="longest",
                                     sampling_rate=16000).input_values

    return {"speech_input": input_values}


valid_loader = DataLoader(ds2,
                          batch_size=1,
...
for batch in tqdm(valid_loader):
    ...
    # for HFSpeechEED
    outputs = spm.generate(batch["speech_input"].to(spm.device),
                           max_length=250,
                           num_beams=10)
